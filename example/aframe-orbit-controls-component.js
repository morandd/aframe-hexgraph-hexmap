	...
	AFRAME.registerComponent('orbit-controls', {
	  ...
	  */
	  ...
	  play: function () {
	    ...
	    // Disable default touch events on the AFrame canvas
	    // https://www.sitepoint.com/pointer-events-will-make-cross-browsers-touch-support-easy/
	    if (window.PointerEvent) {
	    	var setTouchAction = function(t){
	    		if (!t) t = this;
	    		if (t.el.sceneEl.canvas) {
	    			console.log('setTouchAction success');
	    			t.el.sceneEl.canvas.style.touchAction='none';
	    		} else {
	    			console.log('setTouchAction found no target. Waiting 300ms');
	    			window.setTimeout(setTouchAction.bind(t), 1000);
	    		}
	    	};
	    	setTouchAction(this);
		}
	  ...
	  addEventListeners: function () {
	    ...
	    if (window.PointerEvent) {
		    this.canvasEl.addEventListener('pointerdown', this.onMouseDown, false);
	    } else {
	  ...
	  removeEventListeners: function () {
	  	console.log('removinglisterners'); //ddmx

	    this.canvasEl.removeEventListener('pointerdown', this.onMouseDown, false);
	    this.canvasEl.removeEventListener('pointerup', this.onMouseUp, false);
	    this.canvasEl.removeEventListener('pointermove', this.onMouseMove, false);
...
//ddmx
	    ...
	    if (this.state !== this.STATE.NONE) {
	    	if (window.PointerEvent) {
				this.canvasEl.addEventListener('pointermove', this.onMouseMove, false);
				this.canvasEl.addEventListener('pointerup', this.onMouseUp, false);
				this.canvasEl.addEventListener('pointerout', this.onMouseUp, false);
				this.canvasEl.addEventListener('pointercancel', this.onMouseUp, false);
	    	} else {
...
//ddmx
	    ...
	    if (window.PointerEvent) {
			this.canvasEl.removeEventListener('pointermove', this.onMouseMove, false);
			this.canvasEl.removeEventListener('pointerup', this.onMouseUp, false);
			this.canvasEl.removeEventListener('pointerout', this.onMouseUp, false);
			this.canvasEl.removeEventListener('pointercancel', this.onMouseUp, false);
	    } else {
			this.canvasEl.removeEventListener('mousemove', this.onMouseMove, false);
			this.canvasEl.removeEventListener('mouseup', this.onMouseUp, false);
			this.canvasEl.removeEventListener('mouseout', this.onMouseUp, false);
